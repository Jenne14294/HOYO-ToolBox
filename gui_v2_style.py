...
from PyQt5.QtWidgets import (
    QApplication, QVBoxLayout, QHBoxLayout, QRadioButton, QButtonGroup, QLabel, QComboBox, QWidget, QFrame, QPushButton, QScrollArea, QFileDialog, QMessageBox, QDialog, QTextEdit
)
...
class MainWindow(QWidget):
    ...
    def initUI(self):
        ...
        try:
            ...
            self.app_font = QFont(self.font_family)
        ...
        self.language_combo.addItems(["繁體中文", "簡體中文", "英文", "日文"])
